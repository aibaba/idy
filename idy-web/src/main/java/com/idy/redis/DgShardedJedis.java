 ...
 * 封装ShardedJedis的方法
 * @author gaopengbd
 * @date 2014年11月24日 下午2:59:54 
 * @version V1.0
 */
@Component
public class DgShardedJedis {

	private static final Logger logger = LoggerFactory.getLogger(DgShardedJedis.class);

    public void disconnect() {
        ShardedJedis jedis = JedisPool.getJedis();
        jedis.disconnect();
    }
    ...
    public Long hset(String key, String field, String value) {
        ...
        try {
            ...
            JedisPool.returnResource(jedis, broken);
        }
        return result;
    }
	...
	public List<Object> pipelined(ShardedJedisPipeline jedisPipeline) {
        ShardedJedis jedis = JedisPool.getJedis();
